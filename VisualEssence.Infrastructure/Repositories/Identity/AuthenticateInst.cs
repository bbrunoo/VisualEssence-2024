...
{
    public class AuthenticateInst : IAuthenticateInst
    {
        private readonly ApplicationDbContext _context;
        private readonly IConfiguration _configuration;

        public AuthenticateInst(ApplicationDbContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        {
            var usuario = await _context.UserInst.Where(x => x.Email.ToLower() == email.ToLower()).FirstOrDefaultAsync();
        ...
        {
            return await _context.UserInst.Where(x => x.Email.ToLower() == email.ToLower()).FirstOrDefaultAsync();
        }
