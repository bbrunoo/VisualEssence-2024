...
export class HistoricoService {
  ...
  getHistoricoMiopia(): Observable<any[]> {
    return this.http.get<any[]>(`${this.api}/JogadaPais/historico/miopia`).pipe(
      catchError(error => {
  ...
  getHistoricoDaltonismo(): Observable<any[]> {
    return this.http.get<any[]>(`${this.api}/JogadaPais/historico/daltonismo`).pipe(
      catchError(error => {
  ...
  getHistoricoFigurasColoridas(): Observable<any[]> {
    return this.http.get<any[]>(`${this.api}/JogadaPais/historico/figuras-coloridas`).pipe(
      catchError(error => {
