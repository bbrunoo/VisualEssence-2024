...
@Component({
  selector: 'app-dalto-animais-pais-cadastro',
  standalone: true,
  imports: [VlibrasComponent, LogoMenuComponent, FormsModule],
  templateUrl: './dalto-animais-pais-cadastro.component.html',
  styleUrl: './dalto-animais-pais-cadastro.component.css'
})
export class DaltoAnimaisPaisCadastroComponent {
  nomecrianca = '';
  ...
  salvarCrianca(){
   ...
   this.router.navigate(["/Pais/jogos/daltonismo-animais/instrucoes"]);
  }
}
