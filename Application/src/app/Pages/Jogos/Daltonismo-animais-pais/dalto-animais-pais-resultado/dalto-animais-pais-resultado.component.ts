...
@Component({
  selector: 'app-dalto-animais-pais-resultado',
  standalone: true,
  imports: [LogoMenuComponent, NgIf, RouterLink],
  templateUrl: './dalto-animais-pais-resultado.component.html',
  styleUrl: './dalto-animais-pais-resultado.component.css'
})
export class DaltoAnimaisPaisResultadoComponent {
  result: MiopiaResult;
