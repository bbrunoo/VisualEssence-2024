...
@Component({
  selector: 'app-dalto-animais-inst',
  standalone: true,
  imports: [NgFor],
  templateUrl: './dalto-animais-inst.component.html',
  styleUrl: './dalto-animais-inst.component.css'
})
export class DaltoAnimaisInstComponent {
  ...
  proximaFase() {
    if (this.faseAtual < this.fases.length - 1) {
      ...
      this.router.navigate(['/instituicao/jogos/daltonismo-animais/resultado'], { state: { data: this.result } });
    }
  }
