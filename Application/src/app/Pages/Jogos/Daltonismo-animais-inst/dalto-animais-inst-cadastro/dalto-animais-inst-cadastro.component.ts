...
@Component({
  selector: 'app-dalto-animais-inst-cadastro',
  standalone: true,
  imports: [LogoMenuInstComponent, NgFor, CommonModule, FormsModule],
  templateUrl: './dalto-animais-inst-cadastro.component.html',
  styleUrl: './dalto-animais-inst-cadastro.component.css'
})
export class DaltoAnimaisInstCadastroComponent {
