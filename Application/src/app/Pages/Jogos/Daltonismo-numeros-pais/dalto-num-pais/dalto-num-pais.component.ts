...
@Component({
  selector: 'app-dalto-num-pais',
  standalone: true,
  imports: [LogoMenuComponent, NgIf],
  templateUrl: './dalto-num-pais.component.html',
  styleUrl: './dalto-num-pais.component.css'
})
export class DaltoNumPaisComponent {
  ...
  navigateToResults() {
    ...
    this.router.navigate(['/Pais/jogos/daltonismo-numeros/resultado'], { state: { data: result } });
  }
}
